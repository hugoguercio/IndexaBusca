...
public class FrameInicio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Escolha a função de Hash");

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Função 1", "Função 2", "Função 3", "Função 4", "Função 5" }));
